    ...
    <div class="main">
        ...
        <div class="manage">
            <form action="../announces">
                <table class="form">
                    <tr>
                        <td><input type="hidden"  name="id" value="${param.eaId}" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="title" value="${param.eaTitle}" /></td>
                    </tr>
                    <tr>
                        <td class="field">公告内容：</td>
                        <td><textarea name="content">${param.eaContent}</textarea></td>
                    </tr>
                    <tr>
                        <td></td>
